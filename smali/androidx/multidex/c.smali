...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, Landroidx/multidex/c;->a:Ljava/io/File;

    iput-object p2, p0, Landroidx/multidex/c;->c:Ljava/io/File;

    invoke-static {p1}, Landroidx/multidex/c;->b(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, Landroidx/multidex/c;->b:J
    ...
    iput-object p2, p0, Landroidx/multidex/c;->d:Ljava/io/RandomAccessFile;

    :try_start_0
    iget-object p2, p0, Landroidx/multidex/c;->d:Ljava/io/RandomAccessFile;

    invoke-virtual {p2}, Ljava/io/RandomAccessFile;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object p2

    iput-object p2, p0, Landroidx/multidex/c;->e:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iget-object p2, p0, Landroidx/multidex/c;->e:Ljava/nio/channels/FileChannel;

    invoke-virtual {p2}, Ljava/nio/channels/FileChannel;->lock()Ljava/nio/channels/FileLock;

    move-result-object p2

    iput-object p2, p0, Landroidx/multidex/c;->f:Ljava/nio/channels/FileLock;
    :try_end_1
...
.method private a(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, Landroidx/multidex/c;->a:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, Landroidx/multidex/c;->a(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-object v9, v0, Landroidx/multidex/c;->c:Ljava/io/File;
    ...
    invoke-static {v8}, Landroidx/multidex/c;->b(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, Landroidx/multidex/c$a;->a:J
    ...
    iget-wide v2, v8, Landroidx/multidex/c$a;->a:J
    ...
    iget-wide v4, v8, Landroidx/multidex/c$a;->a:J
...
.method private static a(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    ...
    invoke-static {p0}, Landroidx/multidex/c;->a(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    iget-wide v0, p4, Landroidx/multidex/c$a;->a:J
...
.method private static a(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p1}, Landroidx/multidex/c;->a(Ljava/io/File;)J
...
.method private static b(Ljava/io/File;)J
    ...
    invoke-static {p0}, Landroidx/multidex/d;->a(Ljava/io/File;)J
...
.method private j()V
    ...
    iget-object v0, p0, Landroidx/multidex/c;->c:Ljava/io/File;

    new-instance v1, Landroidx/multidex/b;

    invoke-direct {v1, p0}, Landroidx/multidex/b;-><init>(Landroidx/multidex/c;)V
    ...
    iget-object v2, p0, Landroidx/multidex/c;->c:Ljava/io/File;
...
.method private k()Ljava/util/List;
    ...
    iget-object v6, v1, Landroidx/multidex/c;->a:Ljava/io/File;
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/multidex/c;->j()V
    ...
    iget-object v0, v1, Landroidx/multidex/c;->a:Ljava/io/File;
    ...
    new-instance v11, Landroidx/multidex/c$a;

    iget-object v12, v1, Landroidx/multidex/c;->c:Ljava/io/File;

    invoke-direct {v11, v12, v0}, Landroidx/multidex/c$a;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v11, v6}, Landroidx/multidex/c;->a(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, Landroidx/multidex/c;->b(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, Landroidx/multidex/c$a;->a:J
    :try_end_1
    ...
    iget-wide v12, v11, Landroidx/multidex/c$a;->a:J
...
.method a(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/multidex/c;->a:Ljava/io/File;
    ...
    iget-object v0, p0, Landroidx/multidex/c;->f:Ljava/nio/channels/FileLock;
    ...
    iget-object v0, p0, Landroidx/multidex/c;->a:Ljava/io/File;

    iget-wide v2, p0, Landroidx/multidex/c;->b:J

    invoke-static {p1, v0, v2, v3, p2}, Landroidx/multidex/c;->a(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/multidex/c;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    :goto_1
    invoke-direct {p0}, Landroidx/multidex/c;->k()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, Landroidx/multidex/c;->a:Ljava/io/File;

    invoke-static {v0}, Landroidx/multidex/c;->a(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Landroidx/multidex/c;->b:J
    ...
    invoke-static/range {v2 .. v8}, Landroidx/multidex/c;->a(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
...
.method public close()V
    ...
    iget-object v0, p0, Landroidx/multidex/c;->e:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    iget-object v0, p0, Landroidx/multidex/c;->d:Ljava/io/RandomAccessFile;
