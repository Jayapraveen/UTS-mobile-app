...
.method a(IIII)Landroid/view/View;
    ...
    invoke-interface {v5, v4}, Landroidx/recyclerview/widget/M$b;->a(Landroid/view/View;)I

    move-result v5

    iget-object v6, p0, Landroidx/recyclerview/widget/M;->a:Landroidx/recyclerview/widget/M$b;

    invoke-interface {v6, v4}, Landroidx/recyclerview/widget/M$b;->b(Landroid/view/View;)I

    move-result v6

    iget-object v7, p0, Landroidx/recyclerview/widget/M;->b:Landroidx/recyclerview/widget/M$a;

    invoke-virtual {v7, v0, v1, v5, v6}, Landroidx/recyclerview/widget/M$a;->a(IIII)V

    if-eqz p3, :cond_1

    iget-object v5, p0, Landroidx/recyclerview/widget/M;->b:Landroidx/recyclerview/widget/M$a;

    invoke-virtual {v5}, Landroidx/recyclerview/widget/M$a;->b()V
    ...
    invoke-virtual {v5}, Landroidx/recyclerview/widget/M$a;->a()Z
...
.method a(Landroid/view/View;I)Z
    ...
    invoke-interface {v1}, Landroidx/recyclerview/widget/M$b;->a()I
    ...
    invoke-interface {v3, p1}, Landroidx/recyclerview/widget/M$b;->a(Landroid/view/View;)I

    move-result v3

    iget-object v4, p0, Landroidx/recyclerview/widget/M;->a:Landroidx/recyclerview/widget/M$b;

    invoke-interface {v4, p1}, Landroidx/recyclerview/widget/M$b;->b(Landroid/view/View;)I

    move-result p1

    invoke-virtual {v0, v1, v2, v3, p1}, Landroidx/recyclerview/widget/M$a;->a(IIII)V

    if-eqz p2, :cond_0

    iget-object p1, p0, Landroidx/recyclerview/widget/M;->b:Landroidx/recyclerview/widget/M$a;

    invoke-virtual {p1}, Landroidx/recyclerview/widget/M$a;->b()V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/M$a;->a()Z
