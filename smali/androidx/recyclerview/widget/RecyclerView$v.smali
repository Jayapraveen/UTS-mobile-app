...
.method public a(II)V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$v;->c:Landroid/widget/OverScroller;
...
.method public a(IILandroid/view/animation/Interpolator;)V
    ...
    sget-object p3, Landroidx/recyclerview/widget/RecyclerView;->j:Landroid/view/animation/Interpolator;
...
.method public run()V
    ...
    iget-object v2, v2, Landroidx/recyclerview/widget/RecyclerView;->w:Landroidx/recyclerview/widget/RecyclerView$i;

    iget-object v2, v2, Landroidx/recyclerview/widget/RecyclerView$i;->g:Landroidx/recyclerview/widget/RecyclerView$s;
    ...
    iget-object v3, v0, Landroidx/recyclerview/widget/RecyclerView$v;->g:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->Da:[I
    ...
    iget v5, v0, Landroidx/recyclerview/widget/RecyclerView$v;->a:I

    sub-int v13, v11, v5

    iget v5, v0, Landroidx/recyclerview/widget/RecyclerView$v;->b:I

    sub-int v14, v12, v5

    iput v11, v0, Landroidx/recyclerview/widget/RecyclerView$v;->a:I

    iput v12, v0, Landroidx/recyclerview/widget/RecyclerView$v;->b:I
    ...
    iget-object v5, v3, Landroidx/recyclerview/widget/RecyclerView;->v:Landroidx/recyclerview/widget/RecyclerView$a;

    if-eqz v5, :cond_4

    iget-object v5, v3, Landroidx/recyclerview/widget/RecyclerView;->Fa:[I

    invoke-virtual {v3, v13, v14, v5}, Landroidx/recyclerview/widget/RecyclerView;->a(II[I)V

    iget-object v3, v0, Landroidx/recyclerview/widget/RecyclerView$v;->g:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->Fa:[I
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$s;->b()Z
    ...
    iget-object v9, v9, Landroidx/recyclerview/widget/RecyclerView;->ra:Landroidx/recyclerview/widget/RecyclerView$t;
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView$s;->d()V
    ...
    iget-object v9, v9, Landroidx/recyclerview/widget/RecyclerView;->y:Ljava/util/ArrayList;
    ...
    :cond_7
    iget-object v15, v0, Landroidx/recyclerview/widget/RecyclerView$v;->g:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-virtual {v4, v15, v9}, Landroidx/recyclerview/widget/RecyclerView;->a(II)V
    ...
    invoke-virtual {v4, v5, v3}, Landroidx/recyclerview/widget/RecyclerView;->d(II)V
    ...
    iget-object v4, v4, Landroidx/recyclerview/widget/RecyclerView;->w:Landroidx/recyclerview/widget/RecyclerView$i;

    invoke-virtual {v4}, Landroidx/recyclerview/widget/RecyclerView$i;->b()Z
    ...
    invoke-virtual {v4}, Landroidx/recyclerview/widget/RecyclerView$i;->a()Z
    ...
    iget-object v3, v1, Landroidx/recyclerview/widget/RecyclerView;->pa:Landroidx/recyclerview/widget/p;

    if-eqz v3, :cond_1c

    invoke-virtual {v3, v1, v13, v14}, Landroidx/recyclerview/widget/p;->a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView;->qa:Landroidx/recyclerview/widget/p$a;
