...
.method protected static a(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Landroidx/fragment/app/M;->a(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v4, v0}, Landroidx/fragment/app/M;->a(Ljava/util/List;Landroid/view/View;I)Z
...
.method a(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, La/g/i/s;->p(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, La/g/i/s;->a(Landroid/view/View;Ljava/lang/String;)V
...
.method a(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-static {v3, v5}, La/g/i/s;->a(Landroid/view/View;Ljava/lang/String;)V
    ...
    :cond_3
    new-instance p5, Landroidx/fragment/app/J;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/fragment/app/J;-><init>(Landroidx/fragment/app/M;ILjava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)V

    invoke-static {p1, p5}, Landroidx/fragment/app/N;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroidx/fragment/app/N;
...
.method a(Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/K;-><init>(Landroidx/fragment/app/M;Ljava/util/ArrayList;Ljava/util/Map;)V

    invoke-static {p1, v0}, Landroidx/fragment/app/N;->a(Landroid/view/View;Ljava/lang/Runnable;)Landroidx/fragment/app/N;
...
.method a(Landroid/view/ViewGroup;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p0, p2, p3}, Landroidx/fragment/app/L;-><init>(Landroidx/fragment/app/M;Ljava/util/ArrayList;Ljava/util/Map;)V
...
.method a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p2}, La/g/i/u;->a(Landroid/view/ViewGroup;)Z
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/M;->a(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method a(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-static {p2}, La/g/i/s;->p(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v2}, Landroidx/fragment/app/M;->a(Ljava/util/Map;Landroid/view/View;)V
